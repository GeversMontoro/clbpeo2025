####### Multilevel Mediation with Within-Between Centering + Time×Group on Mediator for EDD #######
...
# EDD with log transformation
data$EDD_log <- log(data$EDD + 1)

# Mediator: EDD (log-transformed)
mediator <- "EDD_log"

sink("model_mlmed_EDD.txt")
cat("=== MULTILEVEL MEDIATION with Within-Between Centering + Time×Group on Mediator for EDD ===\n\n")
...
cat("========================================\n")
cat("FINAL SUMMARY - EDD MEDIATOR\n")
cat("========================================\n\n")
...
sink()
cat("Analysis complete! Results saved to model_mlmed_EDD.txt\n")